...
import com.querifylabs.blog.optimizer.cost.DrillDefaultRelMetadataProvider;
...
//        AbstractRelOptPlanner planner = new HepPlanner(programBuilder.build(), Contexts.of(config));
        ...
        // Register Providers
        JaninoRelMetadataProvider relMetadataProvider = registerJaninoRelMetadataProvider();
