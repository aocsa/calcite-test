...
import com.blazingdb.calcite.expression.expr.IfExpression;
...
import com.blazingdb.calcite.types.Types;
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                if (((CastCallContext)_localctx).repeat != null && ((CastCallContext)_localctx).repeat.isRep.compareTo(Boolean.TRUE)==0)
                    ((CastCallContext)_localctx).e =  FunctionCallFactory.createCast(MajorType.newBuilder().mergeFrom(((CastCallContext)_localctx).dataType.type).setMode(DataMode.REPEATED).build(), pos(((CastCallContext)_localctx).Cast), ((CastCallContext)_localctx).expression.e);
                else
    ...
    public final BooleanTypeContext booleanType() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                setState(128);
                match(BIT);
                ((BooleanTypeContext)_localctx).type =  Types.required(MinorType.BIT);
            }
        }
        catch (RecognitionException re) {
            _localctx.exception = re;
        ...
        try {
            ...
            switch (_input.LA(1)) {
                    ...
                    enterOuterAlt(_localctx, 1);
                {
                    setState(131);
                    match(INT);
                    ((NumTypeContext)_localctx).type =  Types.required(MinorType.INT);
                }
                break;
                case BIGINT:
                    enterOuterAlt(_localctx, 2);
                {
                    setState(133);
                    match(BIGINT);
                    ((NumTypeContext)_localctx).type =  Types.required(MinorType.BIGINT);
                }
                break;
                case FLOAT4:
                    enterOuterAlt(_localctx, 3);
                {
                    setState(135);
                    match(FLOAT4);
                    ((NumTypeContext)_localctx).type =  Types.required(MinorType.FLOAT4);
                }
                break;
                case FLOAT8:
                    enterOuterAlt(_localctx, 4);
                {
                    setState(137);
                    match(FLOAT8);
                    ((NumTypeContext)_localctx).type =  Types.required(MinorType.FLOAT8);
                }
                break;
                case DECIMAL9:
                    enterOuterAlt(_localctx, 5);
                {
                    ...
                    setState(144);
                    match(CParen);
                    ((NumTypeContext)_localctx).type =  MajorType.newBuilder().setMinorType(MinorType.DECIMAL9).setMode(DataMode.REQUIRED).setPrecision(((NumTypeContext)_localctx).precision.value.intValue()).setScale(((NumTypeContext)_localctx).scale.value.intValue()).build();
                }
                break;
                case DECIMAL18:
                    enterOuterAlt(_localctx, 6);
                {
                    ...
                    setState(152);
                    match(CParen);
                    ((NumTypeContext)_localctx).type =  MajorType.newBuilder().setMinorType(MinorType.DECIMAL18).setMode(DataMode.REQUIRED).setPrecision(((NumTypeContext)_localctx).precision.value.intValue()).setScale(((NumTypeContext)_localctx).scale.value.intValue()).build();
                }
                break;
                case DECIMAL28DENSE:
                    enterOuterAlt(_localctx, 7);
                {
                    ...
                    setState(160);
                    match(CParen);
                    ((NumTypeContext)_localctx).type =  MajorType.newBuilder().setMinorType(MinorType.DECIMAL28DENSE).setMode(DataMode.REQUIRED).setPrecision(((NumTypeContext)_localctx).precision.value.intValue()).setScale(((NumTypeContext)_localctx).scale.value.intValue()).build();
                }
                break;
                case DECIMAL28SPARSE:
                    enterOuterAlt(_localctx, 8);
                {
                    ...
                    setState(168);
                    match(CParen);
                    ((NumTypeContext)_localctx).type =  MajorType.newBuilder().setMinorType(MinorType.DECIMAL28SPARSE).setMode(DataMode.REQUIRED).setPrecision(((NumTypeContext)_localctx).precision.value.intValue()).setScale(((NumTypeContext)_localctx).scale.value.intValue()).build();
                }
                break;
                case DECIMAL38DENSE:
                    enterOuterAlt(_localctx, 9);
                {
                    ...
                    setState(176);
                    match(CParen);
                    ((NumTypeContext)_localctx).type =  MajorType.newBuilder().setMinorType(MinorType.DECIMAL38DENSE).setMode(DataMode.REQUIRED).setPrecision(((NumTypeContext)_localctx).precision.value.intValue()).setScale(((NumTypeContext)_localctx).scale.value.intValue()).build();
                }
                break;
                case DECIMAL38SPARSE:
                    enterOuterAlt(_localctx, 10);
                {
                    ...
                    setState(184);
                    match(CParen);
                    ((NumTypeContext)_localctx).type =  MajorType.newBuilder().setMinorType(MinorType.DECIMAL38SPARSE).setMode(DataMode.REQUIRED).setPrecision(((NumTypeContext)_localctx).precision.value.intValue()).setScale(((NumTypeContext)_localctx).scale.value.intValue()).build();
                }
                break;
                case VARDECIMAL:
                    enterOuterAlt(_localctx, 11);
                {
                    ...
                    setState(192);
                    match(CParen);
                    ((NumTypeContext)_localctx).type =  MajorType.newBuilder().setMinorType(MinorType.VARDECIMAL).setMode(DataMode.REQUIRED).setPrecision(((NumTypeContext)_localctx).precision.value.intValue()).setScale(((NumTypeContext)_localctx).scale.value.intValue()).build();
                }
                break;
                default:
                    throw new NoViableAltException(this);
        ...
        try {
            ...
            switch (_input.LA(1)) {
                    ...
                    enterOuterAlt(_localctx, 1);
                {
                    ...
                    ((CharTypeContext)_localctx).type =  MajorType.newBuilder().setMinorType(MinorType.VARCHAR).setMode(DataMode.REQUIRED).setPrecision(((CharTypeContext)_localctx).typeLen.length.intValue()).build();
                }
                break;
                case VARBINARY:
                    enterOuterAlt(_localctx, 2);
                {
                    ...
                    setState(202);
                    ((CharTypeContext)_localctx).typeLen = typeLen();
                    ((CharTypeContext)_localctx).type =  MajorType.newBuilder().setMinorType(MinorType.VARBINARY).setMode(DataMode.REQUIRED).setPrecision(((CharTypeContext)_localctx).typeLen.length.intValue()).build();
                }
                break;
                default:
                    throw new NoViableAltException(this);
        ...
        try {
            ...
            switch (_input.LA(1)) {
                    ...
                    enterOuterAlt(_localctx, 1);
                {
                    setState(213);
                    match(DATE);
                    ((DateTypeContext)_localctx).type =  Types.required(MinorType.DATE);
                }
                break;
                case TIMESTAMP:
                    enterOuterAlt(_localctx, 2);
                {
                    setState(215);
                    match(TIMESTAMP);
                    ((DateTypeContext)_localctx).type =  Types.required(MinorType.TIMESTAMP);
                }
                break;
                case TIME:
                    enterOuterAlt(_localctx, 3);
                {
                    setState(217);
                    match(TIME);
                    ((DateTypeContext)_localctx).type =  Types.required(MinorType.TIME);
                }
                break;
                case TIMESTAMPTZ:
                    enterOuterAlt(_localctx, 4);
                {
                    setState(219);
                    match(TIMESTAMPTZ);
                    ((DateTypeContext)_localctx).type =  Types.required(MinorType.TIMESTAMPTZ);
                }
                break;
                case INTERVAL:
                    enterOuterAlt(_localctx, 5);
                {
                    setState(221);
                    match(INTERVAL);
                    ((DateTypeContext)_localctx).type =  Types.required(MinorType.INTERVAL);
                }
                break;
                case INTERVALYEAR:
                    enterOuterAlt(_localctx, 6);
                {
                    setState(223);
                    match(INTERVALYEAR);
                    ((DateTypeContext)_localctx).type =  Types.required(MinorType.INTERVALYEAR);
                }
                break;
                case INTERVALDAY:
                    enterOuterAlt(_localctx, 7);
                {
                    setState(225);
                    match(INTERVALDAY);
                    ((DateTypeContext)_localctx).type =  Types.required(MinorType.INTERVALDAY);
                }
                break;
                default:
                    throw new NoViableAltException(this);
