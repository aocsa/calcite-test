...
public abstract class PathSegment {
     ...
     * @see #originalValue
     */
    protected final MajorType originalValueType;

    private PathSegment child;

    private int hash;

    public PathSegment(PathSegment child, Object originalValue, MajorType originalValueType) {
    ...
    public MajorType getOriginalValueType() {
    ...
    public static final class ArraySegment extends PathSegment {
        ...
        public ArraySegment(int index, Object originalValue, MajorType valueType) {
    ...
    public static final class NameSegment extends PathSegment {
        ...
        public NameSegment(CharSequence n, Object originalValue, MajorType valueType) {
            super(null, originalValue, valueType);
